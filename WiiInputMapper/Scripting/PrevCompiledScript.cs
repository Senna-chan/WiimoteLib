...
{
	public class PrevCompiledScript
	{
...
float mousespeed = 1.0f;
		...
		if(allowPress) Keyboard.SinglePress(KeyCode.R);
			...
			if(allowPress) {
				Keyboard.Press(KeyCode.W, Wiimote.Nunchuk.Joystick.X > 55);
				Keyboard.Press(KeyCode.S, Wiimote.Nunchuk.Joystick.X < -55);
				Keyboard.Press(KeyCode.A, Wiimote.Nunchuk.Joystick.Y > 55);
				Keyboard.Press(KeyCode.D, Wiimote.Nunchuk.Joystick.Y < -55);
			}
...
if(allowPress) {
	Keyboard.Press.W = Wiimote.Nunchuk.Joystick.X > 55;
	Keyboard.Press.S = Wiimote.Nunchuk.Joystick.X < -55;
	Keyboard.Press.A = Wiimote.Nunchuk.Joystick.Y > 55;
	Keyboard.Press.D = Wiimote.Nunchuk.Joystick.Y < -55;
}
